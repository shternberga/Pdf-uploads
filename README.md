...
composer create-project --prefer-dist laravel/laravel blog
 php artisan serve command which will make your server available at http://localhost:8000
 ...
 https://www.codovel.com/laravel-55-easy-crud-step-by-step-tutorial.html
 
 please export laravel built-in pagination files by going to terminal or command prompt (for window users), navigate to your project directory (/demo), and run this command
